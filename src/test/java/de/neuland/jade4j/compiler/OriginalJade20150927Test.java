...
public class OriginalJade20150927Test {
	...
	@Test
	public void testCasesIntepolatedElements() throws IOException, JadeCompilerException {
		testJade("cases/intepolated-elements");
	}
	...
	private void testJade(String path) throws IOException {
		File file = new File(TestFileHelper.getOriginal20150927ResourcePath(path + ".jade"));
